...
public class PickupAdminController {
    ...
    public ResponseEntity<Void> updatePickup(@PathVariable("pickupId") Long pickupId, @RequestBody PickupRequestDto dto) {
    ...
    public ResponseEntity<Void> deletePickup(@PathVariable("pickupId") Long pickupId) {
