...
@RestController
@RequestMapping("/api/admin/{pickupId}/apply")
...
public class PickupJoinAdminController {
    ...
    public ResponseEntity<List<PickupJoinResponseDto>> getAppliedUsersByPickup(@PathVariable("pickupId") Long pickupId) {
    ...
    public ResponseEntity<Void> handleUserApply(@PathVariable("pickupId") Long pickupId, @PathVariable("pickupJoinId") Long pickupJoinId, @RequestBody Status status) {
